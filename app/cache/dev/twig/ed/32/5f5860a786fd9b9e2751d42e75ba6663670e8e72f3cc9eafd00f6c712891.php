...
class __TwigTemplate_ed325f5860a786fd9b9e2751d42e75ba6663670e8e72f3cc9eafd00f6c712891 extends Twig_Template
{
...
\t\t<a href=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_category_show", array("forumName" => $this->getContext($context, "forumName"), "categoryId" => $this->getAttribute($this->getContext($context, "category"), "id"))), "html", null, true);
        echo "\" title=\"";
...
\t\t\t<tbody>";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "category"), "boards"));
...
\t<br>";
    ...
    {
        return "JlfaForumBundle:User/Category/Partial:item_category.html.twig";
    }
