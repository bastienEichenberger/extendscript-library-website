...
/* JlfaForumBundle:User/Post:delete.html.twig */
class __TwigTemplate_094490ce0880ec0e2c6ddd730299372538c94ca2262e1e26100faba1fa28de3e extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "post"), "user"), "delete"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.post.delete", array("%post_id%" => $this->getAttribute($this->getContext($context, "post"), "id"))), "html", null, true);
    }
    ...
    public function block_body_content($context, array $blocks = array())
    {
        ...
        // line 20
        $this->env->getExtension('form')->renderer->setTheme($this->getContext($context, "form"), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "post"), "user"), "delete"), "form_theme")));
        // line 21
        echo "<form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_post_delete_process", array("forumName" => $this->getContext($context, "forumName"), "postId" => $this->getAttribute($this->getContext($context, "post"), "id"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t\t                <input type=\"submit\" class=\"btn btn-primary\" value=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("form.button.post.delete"), "html", null, true);
        // line 41
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:User/Post:delete.html.twig";
    }
