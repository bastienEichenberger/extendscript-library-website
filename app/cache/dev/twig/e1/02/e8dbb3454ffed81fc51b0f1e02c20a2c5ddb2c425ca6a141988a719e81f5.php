...
class __TwigTemplate_e102e8dbb3454ffed81fc51b0f1e02c20a2c5ddb2c425ca6a141988a719e81f5 extends Twig_Template
{
...
\t\t<div class=\"well pre-scrollable\">";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "topic"), "getPosts"));
...
\t\t\t\t\t\t\t\t\t";
                // line 31
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "getBody"), "html", null, true);
                echo "
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t</div>
...
\t</div>";
    ...
    {
        return "JlfaForumBundle:User/Topic/Partial:transcript.html.twig";
    }
