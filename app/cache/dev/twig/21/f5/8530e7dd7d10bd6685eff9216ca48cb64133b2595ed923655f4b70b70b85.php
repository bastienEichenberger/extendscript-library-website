...
class __TwigTemplate_21f58530e7dd7d10bd6685eff9216ca48cb64133b2595ed923655f4b70b70b85 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 26
        $context["panel"] = $context["post_panel"]->getclass($this->getContext($context, "post"), $this->getAttribute($this->getContext($context, "post"), "topic"));
        // line 28
...
\t\t    <header class=\"panel-heading\">";
        // line 32
        $this->env->loadTemplate("CCDNForumForumBundle:User:Post/Partial/item_post_head.html.twig")->display(array_merge($context, array("post" => $this->getContext($context, "post"))));
        // line 33
        echo "</header>

\t\t\t<div class=\"panel-body\">";
        // line 36
        $this->env->loadTemplate("CCDNForumForumBundle:User:Post/Partial/item_post_body.html.twig")->display(array_merge($context, array("post" => $this->getContext($context, "post"))));
        // line 37
        echo "</div>
...
\t</div>";
    ...
    public function getclass($_post = null, $_topic = null)
    {
        ...
        try {
            ...
            if (($this->getAttribute($this->getContext($context, "post"), "isDeleted") == true)) {
                ...
                // line 8
                if (($this->getAttribute($this->getContext($context, "post"), "id") && $this->getAttribute($this->getContext($context, "post"), "topic"))) {
                    // line 9
                    if ($this->getAttribute($this->getAttribute($this->getContext($context, "post"), "topic"), "firstPost")) {
                        // line 10
                        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "post"), "topic"), "firstPost"), "id") == $this->getAttribute($this->getContext($context, "post"), "id"))) {
                            // line 11
                            echo "panel-primary";
                        } else {
                            // line 13
    ...
    {
        return "JlfaForumBundle:User/Post/Partial:item_post.html.twig";
    }
