...
/* JlfaForumBundle:Admin/Category:delete.html.twig */
class __TwigTemplate_7da26e0b166e101e980b152c4420823712528af9f7bcf6efa987bdd18aca8f84 extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "category"), "admin"), "delete"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.admin.manage-categories.delete", array("%category_name%" => $this->getAttribute($this->getContext($context, "category"), "name"))), "html", null, true);
    }
    ...
    public function block_body_content($context, array $blocks = array())
    {
        ...
        // line 20
        $this->env->getExtension('form')->renderer->setTheme($this->getContext($context, "form"), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "category"), "admin"), "delete"), "form_theme")));
        // line 21
        echo "<form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_admin_category_delete_process", array("categoryId" => $this->getAttribute($this->getContext($context, "category"), "id"), "forum_filter" => $this->getContext($context, "forum_filter"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:Admin/Category:delete.html.twig";
    }
