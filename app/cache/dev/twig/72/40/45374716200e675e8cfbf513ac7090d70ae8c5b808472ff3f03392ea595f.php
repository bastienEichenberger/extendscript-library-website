...
/* JlfaForumBundle:Moderator/Post:unlock.html.twig */
class __TwigTemplate_724045374716200e675e8cfbf513ac7090d70ae8c5b808472ff3f03392ea595f extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "post"), "moderator"), "unlock"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.post.unlock", array("%topic_title%" => $this->getAttribute($this->getContext($context, "topic"), "getTitle"))), "html", null, true);
    }
    ...
    public function block_body_content($context, array $blocks = array())
    {
        ...
        // line 20
        $this->env->getExtension('form')->renderer->setTheme($this->getContext($context, "form"), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "post"), "moderator"), "unlock"), "form_theme")));
        // line 21
        echo "<form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_moderator_post_unlock_process", array("forumName" => $this->getContext($context, "forumName"), "postId" => $this->getAttribute($this->getContext($context, "post"), "getId"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t\t\t\t\t\t<input type=\"submit\" class=\"btn btn-danger\" value=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("form.button.post.unlock"), "html", null, true);
        // line 52
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:Moderator/Post:unlock.html.twig";
    }
