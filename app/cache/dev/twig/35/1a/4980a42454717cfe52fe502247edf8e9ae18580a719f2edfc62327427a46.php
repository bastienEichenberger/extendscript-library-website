...
/* JlfaForumBundle:Admin/Board:edit.html.twig */
class __TwigTemplate_351a4980a42454717cfe52fe502247edf8e9ae18580a719f2edfc62327427a46 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 4
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "board"), "admin"), "edit"), "layout_template");
    ...
    {
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.admin.manage-boards.edit", array("%board_name%" => $this->getAttribute($this->getContext($context, "board"), "name"))), "html", null, true);
    }
...
\t    <form action=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_admin_board_edit_process", array("boardId" => $this->getAttribute($this->getContext($context, "board"), "id"), "forum_filter" => $this->getContext($context, "forum_filter"), "category_filter" => $this->getContext($context, "category_filter"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:Admin/Board:edit.html.twig";
    }
