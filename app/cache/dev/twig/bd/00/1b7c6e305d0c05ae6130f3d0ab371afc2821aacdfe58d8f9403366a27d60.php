...
/* JlfaForumBundle:Moderator/Topic:change_board.html.twig */
class __TwigTemplate_bd001b7c6e305d0c05ae6130f3d0ab371afc2821aacdfe58d8f9403366a27d60 extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "topic"), "moderator"), "change_board"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.topic.change_board", array("%topic_title%" => $this->getAttribute($this->getContext($context, "topic"), "getTitle"))), "html", null, true);
    }
    ...
    public function block_body_content($context, array $blocks = array())
    {
        ...
        // line 20
        $this->env->getExtension('form')->renderer->setTheme($this->getContext($context, "form"), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "topic"), "moderator"), "change_board"), "form_theme")));
        // line 21
        echo "<form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_moderator_topic_change_board_process", array("forumName" => $this->getContext($context, "forumName"), "topicId" => $this->getAttribute($this->getContext($context, "topic"), "getId"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t\t\t\t\t<label class=\"col-lg-2 control-label\">";
        // line 37
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("topic.label"), "html", null, true);
        // line 38
        echo "</label>
\t\t\t\t\t<div class=\"col-lg-10\">
\t\t\t\t\t\t<pre>";
...
\t\t\t\t\t\t<input type=\"submit\" class=\"btn btn-danger\" value=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("form.button.topic.move"), "html", null, true);
        // line 52
        echo "\" name=\"submit[post]\" id=\"submit[post]\">

\t\t\t\t\t\t<a class=\"btn btn-default\" href=\"";
        // line 54
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_topic_show", array("topicId" => $this->getAttribute($this->getContext($context, "topic"), "id"))), "html", null, true);
        echo "\">";
        // line 55
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:Moderator/Topic:change_board.html.twig";
    }
