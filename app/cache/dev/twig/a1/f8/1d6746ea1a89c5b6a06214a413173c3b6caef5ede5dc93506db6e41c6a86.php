...
/* JlfaForumBundle:Admin/Forum:edit.html.twig */
class __TwigTemplate_a1f81d6746ea1a89c5b6a06214a413173c3b6caef5ede5dc93506db6e41c6a86 extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "forum"), "admin"), "edit"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.admin.manage-forums.edit", array("%forum_name%" => $this->getAttribute($this->getContext($context, "forum"), "name"))), "html", null, true);
    }
    ...
    public function block_body_content($context, array $blocks = array())
    {
        ...
        // line 20
        $this->env->getExtension('form')->renderer->setTheme($this->getContext($context, "form"), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "forum"), "admin"), "edit"), "form_theme")));
        // line 21
        echo "<form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_admin_forum_edit_process", array("forumId" => $this->getAttribute($this->getContext($context, "forum"), "id"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:Admin/Forum:edit.html.twig";
    }
