...
class __TwigTemplate_d2b991457193e81ed1424cb45e0ab34c3abac8593bf1c7be7e74ec60be4ab092 extends Twig_Template
{
    ...
    <div class=\"modal-content\">
      ...
      <div class=\"modal-footer\">
        ...
        echo "\" method=\"post\">
            ...
            ";
        // line 17
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("SdzBlogBundle:blog:delete_form", array("id" => $this->getAttribute($this->getContext($context, "article"), "id"))));
        echo "
        </form>
      </div>
    </div><!-- /.modal-content -->
