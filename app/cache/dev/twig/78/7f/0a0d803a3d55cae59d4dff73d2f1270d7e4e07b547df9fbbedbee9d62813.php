...
/* JlfaForumBundle:User/Topic:show.html.twig */
class __TwigTemplate_787f0a0d803a3d55cae59d4dff73d2f1270d7e4e07b547df9fbbedbee9d62813 extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "topic"), "user"), "show"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.topic.show", array("%topic_title%" => twig_capitalize_string_filter($this->env, $this->getAttribute($this->getContext($context, "topic"), "getTitle")))), "html", null, true);
    }
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:User/Topic:show.html.twig";
    }
