...
/* JlfaForumBundle:Admin/Category:edit.html.twig */
class __TwigTemplate_6ad7fbdb61091ec2cfe12dd8bc6cddf1503d21ed9f6ccb833165eeea78b55ff5 extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "category"), "admin"), "edit"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.admin.manage-categories.edit", array("%category_name%" => $this->getAttribute($this->getContext($context, "category"), "name"))), "html", null, true);
    }
    ...
    public function block_body_content($context, array $blocks = array())
    {
        ...
        // line 20
        $this->env->getExtension('form')->renderer->setTheme($this->getContext($context, "form"), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "ccdn_forum_forum"), "category"), "admin"), "edit"), "form_theme")));
        // line 21
        echo "<form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_admin_category_edit_process", array("categoryId" => $this->getAttribute($this->getContext($context, "category"), "id"), "forum_filter" => $this->getContext($context, "forum_filter"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t</section>";
    ...
    {
        return "JlfaForumBundle:Admin/Category:edit.html.twig";
    }
