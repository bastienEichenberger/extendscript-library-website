...
namespace Jlfa\ForumBundle\Model\Component\Repository;

use CCDNForum\ForumBundle\Model\Component\Repository\Repository as BaseRepository;
...
class TopicRepository extends BaseRepository
{
    ...
    public function findAllTopicsStickiedByBoardId($boardId, $canViewDeletedTopics = false)
    {
        ...
        $params = array(':boardId' => $boardId, ':isSticky' => 1);
